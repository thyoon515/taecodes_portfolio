...
export default function WhatsNewBanner() {
  ...
  return (
    <Box ref={ref} className="reveal" sx={{ py: { xs: 6, md: 8 } }}>
      <Container maxWidth="lg">
        ...
        >
          ...
          {/* Two-column flex: text left, illustration right */}
          <Box
            sx={{
              position: "relative",
              display: "flex",
          ...
          >
            {/* LEFT: text content */}
            <Box sx={{ flex: { xs: "1 1 100%", md: "1 1 60%" }, maxWidth: 640 }}>
              {/* Weekly badge */}
              <Box
                sx={{
                  display: "inline-flex",
              ...
              {latest && (
                ...
                >
                  ...
                  <Box
                    component="span"
                    sx={{ color: "text.primary", fontStyle: "normal", fontWeight: 600 }}
                  >
                    {latest.title}
                  </Box>
                </Typography>
            ...
            >
              <Box
                ...
                sx={{
                  ...
                  display: "block",
                  borderRadius: 2,
                  filter: "drop-shadow(0 12px 32px rgba(167, 139, 250, 0.25))",
                }}
              />
            </Box>
          </Box>
